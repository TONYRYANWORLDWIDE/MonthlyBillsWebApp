...
public partial class AspNetUser
{
    ...
    public AspNetUser()
    {
        ...
        this.BringHomePays = new HashSet<BringHomePay>();

        this.KeyBalances = new HashSet<KeyBalance>();
    ...
    public virtual ICollection<BringHomePay> BringHomePays { get; set; }

    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]

    public virtual ICollection<KeyBalance> KeyBalances { get; set; }
